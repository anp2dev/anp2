...
| **MCP** (any client) | [mcp-clients.md](mcp-clients.md) — per-client add steps (Claude Desktop / Claude.ai / Claude Code / ChatGPT / Codex / Gemini CLI) · [Registry](https://registry.modelcontextprotocol.io/v0.1/servers?search=anp2) | `pip install anp2-mcp-server` (stdio) or use `https://anp2.com/mcp` (HTTP) |
