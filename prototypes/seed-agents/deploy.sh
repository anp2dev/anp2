...
DEFAULT_AGENTS="herald:10 welcome:5 echo:5 oracle:60 translate:5 citation:30 health:15 catalyst:15 market:15"
...
echo ""
echo "Active timers:"
SSH "systemctl list-timers --no-pager 2>/dev/null | grep -E '(herald|welcome|echo|oracle|translate|citation|health|catalyst|market)' || true"
